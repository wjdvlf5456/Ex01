...
print("    -    ".isspace())        #하나라도 값이 있으면 False


print("======================== 스트링 앞에 0채우기 ========================")
print('20'.zfill(5))               #(문자.zfill(입력한 숫자가 문자포함하여 총 개수가 되고 앞에 0을 붙여준다))  //00020
print('1234'.zfill(10))            #출력결과: //0000001234